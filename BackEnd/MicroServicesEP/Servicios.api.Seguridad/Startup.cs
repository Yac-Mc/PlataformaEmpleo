...
namespace Servicios.api.Seguridad
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMediatR(typeof(RegisterUser.UserRegisterCommand).Assembly);
            services.AddAutoMapper(typeof(RegisterUser.UserRegisterHandler));
            services.AddControllers().AddFluentValidation(x => x.RegisterValidatorsFromAssemblyContaining<RegisterUser>());
            services.AddScoped<IJwtGenerate, JwtGenerate>();
            services.AddScoped<IUserSession, UserSession>();
            services.AddHttpContextAccessor();
            GenerateAuthentication(services);
            GenerateSwagger(services);
        }

        private void GenerateAuthentication(IServiceCollection services)
        {
